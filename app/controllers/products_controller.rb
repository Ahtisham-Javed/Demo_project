class ProductsController < ApplicationController
  before_action :authenticate_user!, only: %i[new create edit update current_user_products]
  ...
  private
    ...
    def product_params
      params.require(:product).permit(:delete_all_product_images, :title, :price, :availability, :description, product_images: [])
    end
end
